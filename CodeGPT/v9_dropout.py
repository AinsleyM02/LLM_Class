...
batch_size = 64  # batch size for training and validation (determines how many samples are used in each iteration)
block_size = 256  # * block size for training and validation (determines the sequence length of the input)
...
class Head(nn.Module):
    ...
    def forward(self, x):
        ...
        weights = self.att_dropout(weights)  # apply dropout to the attention weights
