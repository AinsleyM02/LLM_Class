...
class FeedForward(nn.Module):
    def __init__(self, emb_size):
        ...
        self.net = nn.Sequential(
            ...
            nn.ReLU(), # introduce a non-linearity
        )

    def forward(self, x):
        return self.net(x) # this function defined above
...
class BigramLanguageModel(nn.Module):
    ...
    def __init__(self, vocab_size, emb_size):
        ...
        self.att_head = MultiHeadAttention(8, emb_size // 8) # dim of each attention head is att/8, concat, so still get output of embedding size
        self.feedforward = FeedForward(emb_size) # added this layer, (output is also embedding size?)
